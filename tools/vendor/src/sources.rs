...
pub const SOURCES: &[Source] = &[
    ...
    //
    // Each is a font in its own right, so each is its own family rather than a
    // weight on an existing one. Asking for `phosphor-bold` that way is a build
    // error when the feature is off, where a `Font::weight(Bold)` against a
    // family that only has Regular loaded would silently render Regular.
    // ---------------------------------------------------------------------
    Source {
        ...
        container: Container::Sfnt,
        metadata_url: "https://raw.githubusercontent.com/google/material-design-icons/master/variablefont/MaterialSymbolsRounded%5BFILL%2CGRAD%2Copsz%2Cwght%5D.codepoints",
        metadata: Metadata::Codepoints,
        license_url: Some(
            "https://raw.githubusercontent.com/google/material-design-icons/master/LICENSE",
        ),
    ...
    Source {
        ...
        browse_url: "https://fonts.google.com/icons",
        license: "Apache-2.0",
        font_url: "https://raw.githubusercontent.com/google/material-design-icons/master/variablefont/MaterialSymbolsSharp%5BFILL%2CGRAD%2Copsz%2Cwght%5D.ttf",
        container: Container::Sfnt,
        metadata_url: "https://raw.githubusercontent.com/google/material-design-icons/master/variablefont/MaterialSymbolsSharp%5BFILL%2CGRAD%2Copsz%2Cwght%5D.codepoints",
        metadata: Metadata::Codepoints,
        license_url: Some(
            "https://raw.githubusercontent.com/google/material-design-icons/master/LICENSE",
        ),
    ...
    Source {
        ...
        browse_url: "https://phosphoricons.com",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/thin/Phosphor-Thin.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/thin/style.css",
        // Weighted styles qualify the class: `.ph-thin.ph-acorn`.
        metadata: Metadata::Css {
            prefixes: &[("ph-thin.ph-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/phosphor-icons/web/master/LICENSE"),
    ...
    Source {
        ...
        browse_url: "https://phosphoricons.com",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/light/Phosphor-Light.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/light/style.css",
        metadata: Metadata::Css {
            prefixes: &[("ph-light.ph-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/phosphor-icons/web/master/LICENSE"),
        trim_to_index: true,
        note: None,
    ...
    Source {
        ...
        browse_url: "https://phosphoricons.com",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/bold/Phosphor-Bold.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/bold/style.css",
        metadata: Metadata::Css {
            prefixes: &[("ph-bold.ph-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/phosphor-icons/web/master/LICENSE"),
    ...
    Source {
        ...
        browse_url: "https://phosphoricons.com",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/fill/Phosphor-Fill.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/fill/style.css",
        metadata: Metadata::Css {
            prefixes: &[("ph-fill.ph-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/phosphor-icons/web/master/LICENSE"),
    ...
    Source {
        ...
        browse_url: "https://phosphoricons.com",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/duotone/Phosphor-Duotone.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@phosphor-icons/web/src/duotone/style.css",
        metadata: Metadata::Css {
            prefixes: &[("ph-duotone.ph-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/phosphor-icons/web/master/LICENSE"),
        trim_to_index: true,
        note: Some(
            "Duotone draws two tones from one glyph, so it renders as a single flat \
             colour here rather than the two-tone look the web font achieves with layers.",
        ),
    },
    Source {
        id: "tabler-filled",
        ...
        browse_url: "https://tabler.io/icons",
        license: "MIT",
        font_url: "https://cdn.jsdelivr.net/npm/@tabler/icons-webfont/dist/fonts/tabler-icons-filled.ttf",
        container: Container::Sfnt,
        metadata_url: "https://cdn.jsdelivr.net/npm/@tabler/icons-webfont/dist/tabler-icons-filled.css",
        metadata: Metadata::Css {
            prefixes: &[("ti-", "")],
        },
        license_url: Some("https://raw.githubusercontent.com/tabler/tabler-icons/main/LICENSE"),
        trim_to_index: true,
        note: Some("Only the subset of Tabler icons that has a filled drawing."),
    },
    Source {
        id: "fluent-filled",
        ...
        browse_url: "https://github.com/microsoft/fluentui-system-icons",
        license: "MIT",
        font_url: "https://raw.githubusercontent.com/microsoft/fluentui-system-icons/main/fonts/FluentSystemIcons-Filled.ttf",
        container: Container::Sfnt,
        metadata_url: "https://raw.githubusercontent.com/microsoft/fluentui-system-icons/main/fonts/FluentSystemIcons-Filled.json",
        metadata: Metadata::FlatJson {
            strip_prefix: Some("ic_fluent_"),
            strip_suffix: Some("_filled"),
        },
        license_url: Some(
            "https://raw.githubusercontent.com/microsoft/fluentui-system-icons/main/LICENSE",
        ),
        trim_to_index: true,
        note: Some("Names keep their pixel size, as the Regular style does."),
    },
];
